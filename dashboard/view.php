...
$t = $conn->query("SELECT * FROM teachers WHERE id={$_GET['id']}")->fetch_assoc();
if(!$t) exit('Not found');
?>
<!DOCTYPE html>
<html>
<head>
    <title><?php echo $t['first_name']; ?> - Teacher</title>
...
<div class="container">
    ...
    <div class="body">
        ...
        <div class="row"><span class="label">Phone</span><span><?php echo $t['phone']; ?></span></div>
        <div class="row"><span class="label">Email</span><span><?php echo $t['email']; ?></span></div>
