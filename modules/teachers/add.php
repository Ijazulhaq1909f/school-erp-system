...
if (isset($_POST['save'])) {
    ...
    $msg = $conn->query($sql) ? "<p style='color:green;'>✅ Teacher added!</p>" : "<p style='color:red;'>❌ Error: ".$conn->error."</p>";
}
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <style>
        ...
        button { padding: 12px 30px; background: #27ae60; color: white; border: none; border-radius: 8px; cursor: pointer; font-size: 15px; width: 100%; }
...
<div class="container">
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="form-group"><label>Subject Specialty *</label><input name="subject_specialty" required></div>
